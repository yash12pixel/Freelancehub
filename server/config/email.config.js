...
const config = {
  ...
  email: {
    ...
    <div style="width: 600px; font-size: 18px; background-color: white; color: black;">
      ...
      accountVerification: (username, token) => {
        return `
             <div style="width: 600px; font-size: 18px; background-color: white; color: black;">
              <div style="height: 1px; background-color: rgb(198, 198, 198); width: 100%; margin-top: 15px; margin-bottom: 25px;"></div>
        <div style="padding: 10px 30px 10px 30px;">
          <span style="font-weight: 600;">Hello ${username} ,</span>
          <br>
          <br>

        <a href="http://127.0.0.1:5173/confirm-email">Click here to verified your email</a>
        </div>
        </div>
             </div>
            `;
